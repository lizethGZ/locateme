...
void PushAlert(String token) {
  print('***** **************** $token');
http.post('https://fcm.googleapis.com/fcm/send', headers:<String, String> {
  'Content-Type':'application/json',
  'Authorization':'key=AAAAyDC4rxE:APA91bFSzPSBAiMDt_HBmA7WpRxI_YiRA8pNc0bQbxuqcoYCwMyF6TP2p5d7933DOXh7V-rHO6-hJl9HcGjaCXp0OIlRD_8swRLUEniyLQeT7ne3h1VVs0XtJGq10TA4sHNnIM2FAJct',
...
http.post('https://fcm.googleapis.com/fcm/send', headers:<String, String> {
 ...
 "to":token,
	"notification":<String,dynamic> {
        "body": "Nueva alerta recibida del usuario $alias \n Asunto: $a Coordenadas: ($lat , $long)",
   ...
   var correoShared = finalEmail;
    return Scaffold(
      appBar: AppBar(
        title: Text('Líder'),
        actions: <Widget>[
           IconButton(icon: Icon(Icons.backup_table_outlined),tooltip: 'Usuarios',
            onPressed: () {
              return Navigator.push(context,MaterialPageRoute(builder: (context) => EmisionAlerta()));
            }), 
          IconButton(icon: Icon(Icons.person),tooltip: 'Perfil',
            onPressed: () {
              return Navigator.push(context,MaterialPageRoute(builder: (context) => PerfilPageU2()));
            }), //IconButton
          IconButton(icon: Icon(Icons.logout),tooltip: 'Cerrar sesión',
            onPressed: () {
              showDialog(context: context,builder: (BuildContext context) {
              return AlertDialog(title: Text('¿Quiere cerrar sesión?'),
                actions: <Widget>[
                  FlatButton(child: Text("Sí"),
                  onPressed: () async {
        ...
        elevation: 70.0,
        leading: Image(image: AssetImage('assets/logoMod.png'),), //IconButton
          ...
          children: <Widget>[
            ...
            Container(
              ...
              height: displayHeight(context) *0.04,
                child: Text('($finalLatit,$finalLong)',style: TextStyle(fontSize: 14,foreground: Paint()
      ...
      child: Column(
        children: <Widget>[
          ...
          Container(
            ...
            child: Column(
            children: <Widget>[
              Text('Bienvenido $alias',style: TextStyle(fontSize: 30,foreground: Paint()
            ..style = PaintingStyle.stroke
            ..strokeWidth = 3
     ...
     return Row(
          ...
          children:<Widget>[
            ...
            Container(
              ...
              child: Text("Tipo de alerta: ",style: TextStyle(color:Colors.black,fontSize:20),),
...
requestPerms()async{
  ...
  getIcons() async {
    var icon = await BitmapDescriptor.fromAssetImage(ImageConfiguration(size: Size(75, 75)),'assets/marcadorChido.png');
    setState((){
      this.icon=icon;
    });
  }
