      ...
      appBar: AppBar(
        ...
        actions: <Widget>[
          IconButton(icon: Icon(Icons.person),tooltip: 'Perfil',
            onPressed: () {
              return Navigator.push(context,MaterialPageRoute(builder: (context) => PerfilPage()));
            }), //IconButton
...
requestPerms()async{
 ...
 UpdateStatus(){
  ...
  getIcons() async {
    var icon = await BitmapDescriptor.fromAssetImage(ImageConfiguration(devicePixelRatio: 4.5,size: Size(78, 78, )),'assets/marcadorChido.png');
    setState((){
      this.icon=icon;
    });
  }
