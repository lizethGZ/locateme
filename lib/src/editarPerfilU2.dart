...
http.post("http://locateme.codewaymx.com/actualizarUsuario.php", body: {
    'nombre': nombre.text,
      ...
      return AlertDialog(
        ...
        actions: <Widget>[
          FlatButton(
            child: Text('OK'),
            onPressed: () {
              Navigator.push(context,MaterialPageRoute(builder: (context) => PerfilPageU2()));
            },
          ),
        ],
      );
...
Future<dynamic> verDatos() async {
  final response = await http.post("http://locateme.codewaymx.com/mostrarDatos.php", body: {  
      "correo": correo.text,
  });
...
initState() {
  ...
  Widget _loginForm(BuildContext context){
    ...
    Text('Perfil',style: TextStyle(fontSize: 30,foreground: Paint()
 ...
 Widget _correo(){
    return Container(
      ...
      child: TextFormField(
        ...
        textInputAction: TextInputAction.next,
        controller: correo,decoration: InputDecoration(
      ...
      onPressed: () {
              ...
              return AlertDialog(
                ...
                actions: <Widget>[
                  ...
                  child: Text("Sí"),
                  onPressed: () async {   
                      Navigator.push(context,MaterialPageRoute(builder: (context) => Usuario2Page()));
                  },
                  ),
                  FlatButton(
                  child: Text("No"),
