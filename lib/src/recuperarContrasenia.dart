...
Future<List> recuperar() async {
  final response = await http.post('http://locateme.codewaymx.com/emailRecup.php', body: {
    "correo": user.text,
  });
...
if(datauser[0]==null){
   ...
   ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(
                        content: const Text('El correo de recuperación se envió exitosamente'),
                      ),
                    );  
                    user.text='';
  }
  ...
  return  SingleChildScrollView(
      ...
      child: Column(
        ...
        children: <Widget>[
          // key: _formkey, 
         Text('Recuperar tu contraseña',style: TextStyle(fontSize: 18,foreground: Paint()
