...
final response = await http.post("http://locateme.codewaymx.com/atencionAlerta.php", body: {
     'emision': '$_myState1',
      'entidad': '1',
...
Future<String> _getStateList() async {
  final response = await http.post("http://locateme.codewaymx.com/usuarios.php", body: {  
    'email': '$finalEmail',  
  });
  var datauser = json.decode(response.body);
  setState(() {
...
Future<dynamic> dataEmision() async {
  final response = await http.post("http://locateme.codewaymx.com/DataGridEmision.php", body: {  
      'correo': _myState,
  });
  var datauser = json.decode(response.body);
  setState(() {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: <Widget>[
          ...
          IconButton(icon: Icon(Icons.cancel_presentation_rounded),tooltip: 'Salir',
            onPressed: () {
              return Navigator.push(context,MaterialPageRoute(builder: (context) => Usuario2Page()));
            }), //IconButton
      ...
      child: Column(
        children: <Widget>[
          ...
          Container(
            ...
            child: Column(
            children: <Widget>[
              Text('Atención de alertas',style: TextStyle(fontSize: 30,foreground: Paint()
     ...
     return Row(
          ...
          children:<Widget>[
            ...
            Container(
              ...
              child: Text("Usuario: ",style: TextStyle(color:Colors.black,fontSize:20),),
...
requestPerms()async{
  ...
  getIcons() async {
    var icon = await BitmapDescriptor.fromAssetImage(ImageConfiguration(devicePixelRatio: 2.5),'assets/casa.png');
    setState((){
      this.icon=icon;
    });
  }
  ...
  getIcons1() async {
    var icon2 = await BitmapDescriptor.fromAssetImage(ImageConfiguration(devicePixelRatio: 2.5),'assets/alertaAlert.png');
    setState((){
      this.icon=icon2;
    });
  }
